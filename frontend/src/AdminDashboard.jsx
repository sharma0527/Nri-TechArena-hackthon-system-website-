...
export default function AdminDashboard() {
    ...
    const togglePayments = async () => {
        try {
            ...
            setPaymentStatus(res.data);
            alert(`Payments have been successfully ${res.data.paymentsStopped ? "STOPPED" : "RESUMED"}!`);
        } catch (error) {
            console.error(error);
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "20px" }}>
                ...
                <div style={{ display: "flex", gap: "16px", alignItems: "center" }}>
                    <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                        ...
                        >
                            <option value={2}>Siva Kotamma Challa (Axis)</option>
            ...
            <div style={{
                ...
                <div style={{ textAlign: "center" }}>
                    ...
                    <p style={{ color: "var(--text-secondary)", margin: 0, fontSize: "14px" }}>
                        Timer automatically counts down to 10:00 AM on 25/03/2026. Payments stop automatically at zero, but you can manually bypass this below anytime.
                    </p>
                </div>
