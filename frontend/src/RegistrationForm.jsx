...
export default function RegistrationForm() {
    ...
    useEffect(() => {
        // Clear stale order session on mount for fresh registration
    ...
    const getAmount = () => {
        return 1000; // Strictly enforce ₹1000 fee
    };
                            ...
                            <div style={{
                                ...
                                {verifyResult.success ? (
                                  <div style={{ marginTop: "8px", fontSize: "13px", color: "var(--text-secondary)" }}>
                                      System confidence: 100%. Redirecting to confirmation...
                                  </div>
                                ) : (
                                          ...
                                          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "8px" }}>
                                              {Object.entries(verifyResult.checks).map(([key, val]) => (
                                                  <div key={key} style={{ 
                                                      ...
                                                      color: val ? "var(--success)" : "var(--error)",
